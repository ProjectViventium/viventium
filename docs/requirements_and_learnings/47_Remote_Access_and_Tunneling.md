...
## 2026-07-15 Public-Media Decision And Incident Learning
...
- The current recovery stays config-only and preserves the self-hosted, zero-added-service-cost
  deployment shape. No application runtime code or hosted relay is required for the proven direct
  public TCP path.
...
- `qa/remote-access/reports/2026-07-15-public-call-and-glasshive-links.md`
