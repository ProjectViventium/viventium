...
- **npm globals**: pinned Codex and Claude Code specs (`@openai/codex@0.147.0`,
  `@anthropic-ai/claude-code@2.1.233`) plus the currently floating `openclaw@latest` input. The
...
| `WPR_SANDBOX_CLAUDE_CODE_NPM_SPEC`                                                        | `@anthropic-ai/claude-code@2.1.233`                                                     | Pinned Claude Code package installed into rebuilt workstation images; update only with dated version/QA evidence                                                                                                                                                                                                                                                                    |
