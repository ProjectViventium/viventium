...
- **npm runtimes**: pinned Codex and Claude Code specs (`@openai/codex@0.147.0`,
  `@anthropic-ai/claude-code@2.1.233`) plus the app-owned OpenClaw 2026.7.1-2 runtime installed
