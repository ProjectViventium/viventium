...
| `EMO-039` | Reaction-default migration | New state uses the owner-approved magnitude-neutral instruction; the exact weak legacy default upgrades; any other user instruction remains exact | minimum-strength bias returns, fuzzy migration rewrites custom text, or runtime post-amplifies model output |
