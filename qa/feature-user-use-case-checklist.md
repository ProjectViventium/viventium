...
| MCP tooling and OAuth | [`07_MCPs.md`](../docs/requirements_and_learnings/07_MCPs.md), [`40_Public_Private_Boundaries_and_License_Matrix.md`](../docs/requirements_and_learnings/40_Public_Private_Boundaries_and_License_Matrix.md) | `qa/mcp-tooling/`, `qa/mcp-oauth/`, `qa/background_agents/`, `qa/connected-accounts-handoff/`, `qa/glasshive-mcp-capability-broker/`, `qa/glasshive_host_workers/` | User requests a tool-backed action; OAuth missing/stale grants surface cleanly; model-visible tool schema and result are correct; connected-account historical handoff notes stay separated from the current broker-first path; final answer reflects tool success/failure; retries do not repeat opaque multi-second hot-path failures. |
| GlassHive workspaces, host workers, watch desktop, steer, enterprise VM mode, Standard QA, self-healing, feature requests, and bug reports | [`18_Power_Agents_Beta.md`](../docs/requirements_and_learnings/18_Power_Agents_Beta.md), [`48_GlassHive_Workstation_Sandbox_Runtime.md`](../docs/requirements_and_learnings/48_GlassHive_Workstation_Sandbox_Runtime.md), [`51_GlassHive_Workflows_Self_Healing_and_Feature_Requests.md`](../docs/requirements_and_learnings/51_GlassHive_Workflows_Self_Healing_and_Feature_Requests.md), [`50_Stable_Dev_Runtime.md`](../docs/requirements_and_learnings/50_Stable_Dev_Runtime.md) | `qa/glasshive_standard_qa/`, `qa/glasshive_host_workers/`, `qa/glasshive-mcp-capability-broker/`, `qa/glasshive_workspaces/`, `qa/glasshive_watch_desktop/`, `qa/glasshive_steer/`, `qa/glasshive_azure_enterprise/`, `qa/self-healing/`, `qa/feature-request/`, `qa/bug-report/`, `qa/stable-dev-runtime/` | User delegates host or enterprise VM work, watches/steers desktop/browser, resumes a worker, verifies tenant/user isolation, uses brokered capabilities without provider-secret leakage, uploads and downloads artifacts, approves or rejects changes, files a bug/feature request, runs the mandatory GlassHive Standard QA matrix, uses self-healing, and sees PR/local-change policy respected without leaking private state. |
...
`qa/glasshive_azure_enterprise/`, `qa/glasshive_standard_qa/`, `qa/glasshive-mcp-capability-broker/`,
...
Historical connected-account handoff comparisons live under `qa/connected-accounts-handoff/` and
remain explicitly separate from current broker-first acceptance.
