...
- Primary outcome: Silent/no-response turns suppress visible output only when the contract permits it and never hide errors.
- User-visible surfaces: web, Telegram, voice, scheduler final output.
