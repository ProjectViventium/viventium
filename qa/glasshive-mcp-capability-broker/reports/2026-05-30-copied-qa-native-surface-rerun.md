...
Generated: 2026-05-30T21:34:20.048Z
...
- Post-case observation window: 180000 ms
- Async follow-up grace after cortex completion: 90000 ms
- Native/API completed: 1
- Native/API failed: 0
...
| google_workspace | connected | yes | no |
| scheduling-cortex | connected | no | no |
| glasshive-workers-projects | connected | no | no |
...
| --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| glasshive_inbox_read_only | web | agents_api | completed | not_run |  | 0 | 0 | 0 |  |  |
