# Telegram Local Bot API QA Cases

## Case ID Convention

Use stable `TGBOTAPI-NNN` IDs for telegram local bot api cases.
...
- Requirement: Local Telegram Bot API mode reports readiness and media access accurately.
...
These rows are the minimum natural-user checklist gate for Telegram Local Bot Api. Add narrower feature-specific
