...
| GlassHive | `4d4a3545fca9921148d2c3113bc313e527a78f3b` | reviewed branch tree; review worktree clean | Retains the user-scoped control plane, private workspaces, provider-account/capability brokerage, lifecycle/recovery/artifact foundations, and authorization hardening. It adds the native Codex/Claude package, direct one-call MCP guidance, exact launch follow-up context for clients without stable conversation headers, distinct Codex marketplace identity for correct installed skill resolution, and a versioned Claude package update. Focused runtime/UI compatibility suites, native fresh-process calls, plugin validators, and public-safety checks pass. Hosted artifact identity remains a separate gate. |
