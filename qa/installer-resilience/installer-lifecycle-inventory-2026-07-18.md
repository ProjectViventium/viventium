...
| --- | --- | --- | --- |
| LibreChat | `6af5197425db09a6f1ed5ae2941d886b69725e58` | isolated clean review commit; publication pending | Unifies the authoritative call task plane, durable cancellation/replay, browser capability and agent ACL boundaries, post-call memory hardening, structural speaker-authority gating, durable continuation fencing, server-authoritative gateway readiness, meeting-history seeding, rollback-safe startup, and the current public-safe package lock. Clean install, package builds, API/client suites, focused memory/health/history suites, and secret/history scans pass. Public merge and shipped-artifact identity remain separate gates. |
...
| GlassHive | `4cba3c9c2c1bb81ae8f89c37bee1fcba3af7d565` | isolated clean review commit; publication pending | Unifies the user-scoped control plane, private workspaces, provider-account/capability brokerage, lifecycle/recovery/artifact foundations, signed exact-run actions, current workspace control-room UI and authorization hardening, isolated test state, and retry event-location telemetry. Runtime and UI suites, targeted telemetry tests, browser launch/completion/refresh/catalog/activity QA, persistence checks, and secret/history scans pass. Public merge and built-artifact identity remain separate gates. |
