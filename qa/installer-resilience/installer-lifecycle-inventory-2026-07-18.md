...
| GlassHive | `94ae1ae50b1ad4e8901edf9f2f61df5a8168893c` | public `main` tip; reviewed tree clean | PR 80 merged the reviewed worker, callback, workspace, and capability-broker tree. PR 81 removes the mutable OpenClaw npm override and records the Core-owned recipient-identity boundary. Exact-head contract tests, privacy scans, exact-tree verification, and independent reviews pass. |
