...
### Current Isolated Candidate Reconciliation — 2026-08-21
...
| GlassHive | `f1de874257605d2d7336a180d169b3a616b1de68` | public `main` tip; reviewed content unchanged | Contains the accepted Ultimate Phase 1 implementation and its public release notes: personal Codex/Claude accounts, persistent Favorite workspaces, native connected-service state, one-launch/one-wait external MCP reuse, connection removal, honest quota/auth failures, and scoped lease/isolation recovery. Focused runtime/UI suites, native fresh-client evidence, plugin validators, parent-pin checks, and public-safety scans pass. Clean public install/restore remains a separate gate. |
