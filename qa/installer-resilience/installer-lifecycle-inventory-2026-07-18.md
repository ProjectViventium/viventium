...
| --- | --- | --- | --- |
| LibreChat | `b8501b3c3c752b86663aa846019f59f7855d8634` | merged tree equals audited review head; review worktree clean | Unifies the authoritative call task plane, durable cancellation/replay, browser capability and agent ACL boundaries, post-call memory hardening, structural speaker-authority gating, durable continuation fencing, server-authoritative gateway readiness, meeting-history seeding, rollback-safe startup, and the current public-safe package lock. Clean install, package builds, API/client suites, focused memory/health/history suites, secret/history scans, and all 15 hosted checks pass. Shipped-artifact identity remains a separate gate. |
