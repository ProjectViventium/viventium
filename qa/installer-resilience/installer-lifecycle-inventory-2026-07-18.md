...
| --- | --- | --- | --- |
| LibreChat | `3cc5d5dc71e9533d661ca7e55e958d2b30275c20` | merged tree exact; review worktree clean | PRs 75–79 added GlassHive as a core Provider/Model choice plus exact capability/effort, Opus 5, migration, scheduler, post-upgrade finalization, clustered-startup, canonical managed-agent provisioning, and capability-declared Chat Completions routing for main, cortex, handoff, and Phase B. PR 79 preserves the exact GlassHive wire model and effort while preventing SDK model-name heuristics from switching LibreChat to Responses; all hosted build, lint, dependency, API, data-provider, and data-schema checks passed. Signed/notarized release and installed-runtime identity remain separate gates. |
