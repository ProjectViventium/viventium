...
| --- | --- | --- | --- |
| LibreChat | `6bf2a6ec65fcf6af1a1ce404d25a72a33cce9341` | merged tree exact; review worktree clean | PRs 75–78 added GlassHive as a core Provider/Model choice plus exact capability/effort, Opus 5, migration, scheduler, post-upgrade finalization, clustered-startup, and canonical managed-agent provisioning contracts. PR 78 also aligned the tracked Agent Builder effort template with the executable GlassHive endpoint; all hosted build, lint, dependency, API, data-provider, and data-schema checks passed. Signed/notarized release and installed-runtime identity remain separate gates. |
