...
| --- | --- | --- | --- |
| LibreChat | `8c0b30234f5e99a56a1a0bac1f791575e60eea35` | public `main` tip; reviewed tree clean | PR 112 adds the canonical three-tool GlassHive control plane, installed-layout scheduler failure contract, and managed-agent migration so fresh installs and upgrades receive the same reviewed config. Scheduler, config, migration, privacy, exact-tree, and independent review gates pass. |
...
| agent-starter-react | `ba3f7a622e5fc7080cee1e452a9879cef4f78149` | public `main` tip; reviewed tree clean | PR 13 merged the reviewed compatible LiveKit dependency pins after PR 12's call and voice UI tree. Frozen install, all 297 tests, production build, parent voice dispatch/endurance checks, public-safety scans, and exact-tree verification pass. |
| GlassHive | `34abb90ce1a666b8c15127943b44517bde0dd48d` | public `main` tip; reviewed tree clean | PR 80 merged the reviewed worker, callback, workspace, and capability-broker tree. Compatibility, API, callback, secret-scan, and fresh-clone gates pass, including 262 tests in the fresh clone. |
| Viventium-Health | `d53212f71581c61aee69029732ecc382b43e481a` | public `main` tip; reviewed tree clean | PR 2 merged the reviewed WHOOP runtime and release packaging. The component suite reports 63 passes and 2 credentialed skips; package and fresh-clone gates pass. |
...
| google_workspace_mcp | `fb87b169e6ead9a9d34c4ebf7e31d1489ae47371` | public `main` tip; reviewed tree clean | PR 11 merged the reviewed connector and package tree. All 44 tests, deterministic packaging, public-safety scans, and fresh-clone verification pass. |
