...
- Primary outcome: Viventium logos, favicons, helper assets, and playground assets render from portable public paths.
- User-visible surfaces: web UI, helper/app assets, generated config.
