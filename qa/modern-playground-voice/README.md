...
Latest focused result: the 2026-08-10 post-change browser call passed the `MPV-014` delivery gate.
The real RTC connection received and played the complete assistant response, advanced byte, packet,
duration, and energy counters, transitioned `Speaking -> Listening`, completed the durable voice
task, and produced no page error. See
`reports/2026-08-10-anti-sycophancy-audible-playback-and-worker-port.md`.
...
MPV-025 through MPV-047. The machine-readable execution and coverage contract is
