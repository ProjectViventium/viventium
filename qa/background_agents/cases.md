...
| `ACT-46` | A specialist cortex does not inherit Main-only exact wording or response-shape constraints | Surface-prompt unit tests plus real browser result text proving Red Team and Confirmation Bias produce independent substantive evidence instead of echoing Phase A |
