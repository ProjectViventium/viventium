...
| Pattern Recognition | `agent_viventium_pattern_recognition_95aeb3` | `GlassHive Codex / Sol / medium` | `groq / qwen/qwen3.6-27b` | recurring loops and contradictions |
| Emotional Resonance | `agent_viventium_emotional_resonance_95aeb3` | `GlassHive Codex / Sol / low` | `groq / qwen/qwen3.6-27b` | emotional undercurrents and vulnerability |
| Strategic Planning | `agent_viventium_strategic_planning_95aeb3` | `GlassHive Codex / Sol / high` | `groq / qwen/qwen3.6-27b` | plans, sequencing, roadmaps |
| Viventium User Help | `agent_viventium_support_95aeb3` | `GlassHive Codex / Sol / low` | `groq / qwen/qwen3.6-27b` | in-product support and how-to help |
| Google | `agent_8Y1d7JNhpubtvzYz3hvEv` | `GlassHive Codex / Sol / low` | `groq / qwen/qwen3.6-27b` | `productivity_google_workspace` live Gmail/Drive actions |

## Notes

- The execution-family column is the launch-ready shipped baseline from source-of-truth.
- Every row uses the GlassHive conversation endpoint and declares `anthropic / claude-opus-5` as its managed text
