...
| --- | --- | --- | --- | --- |
| Background Analysis | `agent_viventium_background_analysis_95aeb3` | `anthropic / claude-sonnet-4-5` | `groq / meta-llama/llama-4-scout-17b-16e-instruct` | blind spots, critical analysis |
| Confirmation Bias | `agent_viventium_confirmation_bias_95aeb3` | `anthropic / claude-sonnet-4-5` | `groq / meta-llama/llama-4-scout-17b-16e-instruct` | overconfidence, unchecked assumptions |
...
| Pattern Recognition | `agent_viventium_pattern_recognition_95aeb3` | `anthropic / claude-sonnet-4-5` | `groq / meta-llama/llama-4-scout-17b-16e-instruct` | recurring loops and contradictions |
| Emotional Resonance | `agent_viventium_emotional_resonance_95aeb3` | `anthropic / claude-sonnet-4-5` | `groq / meta-llama/llama-4-scout-17b-16e-instruct` | emotional undercurrents and vulnerability |
| Strategic Planning | `agent_viventium_strategic_planning_95aeb3` | `anthropic / claude-opus-4-8` | `groq / meta-llama/llama-4-scout-17b-16e-instruct` | plans, sequencing, roadmaps |
| Viventium User Help | `agent_viventium_support_95aeb3` | `anthropic / claude-sonnet-4-5` | `groq / meta-llama/llama-4-scout-17b-16e-instruct` | in-product support and how-to help |
