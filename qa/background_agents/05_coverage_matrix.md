...
| MS365 | `ACT-09`, `ACT-11`, `ACT-23`, `ACT-24` | `ACT-12` | Provider-only clarification is a required regression case; deferred tool-cortex holds must not surface generic connection/provider errors when Phase B follows up; source/live tool arrays must include MS365 MCP tools. |
...
| Google | `ACT-10`, `ACT-11`, `ACT-23`, `ACT-24` | `ACT-12` | Concrete Google Workspace action required; deferred tool-cortex holds must not surface generic connection/provider errors when Phase B follows up; source/live tool arrays must include Google Workspace MCP tools. |

## Interpretation

- Coverage in this matrix is activation coverage, not full execution QA.
- Cases with outcome assertions (`ACT-13`, `ACT-14`, `ACT-15`, `ACT-16`, `ACT-17`, `ACT-18`, `ACT-19`, `ACT-20`, `ACT-21`, `ACT-22`, `ACT-23`, `ACT-24`) are promoted incident regressions. They
