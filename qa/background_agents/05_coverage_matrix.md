...
| Deep Memory Search | `ANTI-010` | `ANTI-002`, `ANTI-005` | Structured `activation.mode: always`; authorized retrieval, Phase B value-gating, and silent empty/unavailable results replace classifier coverage. |
