...
| `SCHED-009` | Callback outbox bounded termination and health gate | GlassHive callback outbox, scheduler delivery ledger, metrics | GlassHive callback regressions plus nightly DB/API outbox-health probe | PASS/PARTIAL 2026-07-10 ([callback repair](reports/2026-07-10-workbench-callback-repair.md)); focused regression keeps external 404 terminal while retrying local scheduler 404, fresh run callbacks delivered in one attempt, and only historical/repair-window dead letters remain with no pending or delivering backlog |
...
| `SCHED-014` | Built-in Workbench runs own explicit model/effort provenance and preserve structured failures. | Workbench, Scheduler, GlassHive host worker, callback ledgers | Workbench/Scheduler/GlassHive regressions plus live manual run | PASS-LIVE-MANUAL 2026-07-11; requested/effective `xhigh` completed through callback and visible Workbench history; next automatic run pending |
...
- Last run: PASS-LIVE-MANUAL 2026-07-11; a later manual child completed with requested/effective
  `xhigh`, callbacks/ledgers terminalized, and Workbench browser history persisted after reload.
