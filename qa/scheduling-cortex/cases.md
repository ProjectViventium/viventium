...
| `SCHED-002` | Trigger and delivery ledger | Scheduler trigger, delivery ledger, visible notification/chat | test_scheduling_mcp_supervision.py plus synthetic live scheduled run | FAIL 2026-05-26 ([nightly report](../memory-hardening/reports/2026-05-26-nightly-routines-health-review.md)); scheduler listener was down, the 03:00 Workbench row was overdue, and no current nightly run row existed |
...
- Last run: FAIL 2026-05-26
  ([nightly report](../memory-hardening/reports/2026-05-26-nightly-routines-health-review.md)); the
  scheduler listener was unavailable, the active 03:00 Workbench/GlassHive row was overdue, and no
  current nightly scheduled-prompt run row existed.
...
| `SCHED-UC-002` | On Scheduler trigger, delivery ledger, visible notification/chat, try trigger and delivery ledger with missing setup, missing auth/config, empty state, or a degraded dependency. | owning requirement for `SCHED-002` / `SCHED-002` | Scheduler trigger, delivery ledger, visible notification/chat | Source, owning requirement doc, case steps, logs, DB/state, generated config, and shipped artifact evidence that apply to SCHED-002. | The user sees an honest setup, retry, or degraded-state result for SCHED-002; no fake success is accepted. | FAIL 2026-05-26 ([nightly report](../memory-hardening/reports/2026-05-26-nightly-routines-health-review.md)); scheduler listener was down and the 03:00 Workbench/GlassHive row remained overdue |
