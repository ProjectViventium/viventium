...
- Last catalog reconciliation: 2026-08-29. The current natural continuity path is `FAIL`; other
  cases keep their own dated `PASS`, `PARTIAL`, `BLOCKED`, or `NOT RUN` status in `cases.md`.
